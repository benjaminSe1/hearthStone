...
public class ListCartes {
    ...
    public static ServiteurSimple carteRenfort = new ServiteurSimple("Recrue de la main d'argent", 0, 1, 1);
    public static Serviteur carteMiroir = new ServiteurProvocation(new ServiteurSimple("Recrue miroir", 0, 0, 2));
    public static ServiteurSimple carteMetamorphose = new ServiteurSimple("Métamorphe", 0, 1, 1);
    ...
    static {
        ...
        Serviteur sa3 = new ServiteurCharge(new ServiteurSimple("Chevaucheur de loup", 3, 3, 1));
